...
class SpikeWindowDelegate : public CefWindowDelegate {
public:
    SpikeWindowDelegate(CefRefPtr<CefBrowserView> browser_view,
...
class SpikeBrowserViewDelegate : public CefBrowserViewDelegate {
public:
    explicit SpikeBrowserViewDelegate(cef_runtime_style_t runtime_style)
        : runtime_style_(runtime_style) {}
    ...
    bool OnPopupBrowserViewCreated(CefRefPtr<CefBrowserView> browser_view,
        ...
        CefWindow::CreateTopLevelWindow(
            new SpikeWindowDelegate(popup_browser_view, runtime_style_, CEF_SHOW_STATE_NORMAL));
        return true;
    }
...
void SpikeApp::OnContextInitialized() {
    ...
    CefRefPtr<SpikeHandler> handler(new SpikeHandler(use_alloy_style));
    ...
    if (use_views) {
        CefRefPtr<CefBrowserView> browser_view = CefBrowserView::CreateBrowserView(
            ...
            new SpikeBrowserViewDelegate(runtime_style));
        CefWindow::CreateTopLevelWindow(
            new SpikeWindowDelegate(browser_view, runtime_style, CEF_SHOW_STATE_NORMAL));
    } else {
...
CefRefPtr<CefClient> SpikeApp::GetDefaultClient() {
    return SpikeHandler::GetInstance();
}
